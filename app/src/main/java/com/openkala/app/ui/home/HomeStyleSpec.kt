...
data class HomeStyleSpec(
    ...
    val categorySectionHorizontalPadding: Dp = 12.dp,
    val categorySectionTopPadding: Dp = 10.dp,
    val categorySectionBottomPadding: Dp = 14.dp,
    val categoryPromoCardAspectRatio: Float = 16f / 9f,
    val categoryPromoCardRadius: Dp = 12.dp,
    val categoryPromoGap: Dp = 8.dp,
    val categoryTitleTopPadding: Dp = 14.dp,
    val categoryTitleBottomPadding: Dp = 8.dp,
    val categoryGridRowGap: Dp = 14.dp,
    val categoryGridColumnGap: Dp = 10.dp,
    val categoryCircleSize: Dp = 94.dp,
    val categoryImageSize: Dp = 88.dp,
    val categoryLabelTopPadding: Dp = 6.dp,
